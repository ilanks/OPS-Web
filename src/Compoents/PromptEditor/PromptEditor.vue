        ...
        <div class="operate-tool" ref="operate-tool">
            ...
            >
                ...
                <select v-model="promptEditor.data.server">
                    ...
                    <option value="https://indexfs.moonvy.com:19213/prompt-studio" disabled>腾讯翻译</option>
                    <option value="https://indexfs.moonvy.com:19213/prompt-studio2" disabled>腾讯翻译 2</option>
